// Gemeinsamer Teil von /api/analyze und /api/analyze/block: der Systemprompt (FS
// Crafted Fachwissen) und die deterministische Nachbearbeitung validateAndFix. Reine
// Verschiebung aus route.ts (Task C3, Spec 2026-09-16) — beide Routen kalkulieren mit
// demselben Wissen und derselben Prüfung, statt eine zweite Kopie zu pflegen.
...
export const SYSTEM_PROMPT = `Du bist ein erfahrener Schreinermeister und kalkulierst Angebote für FS Crafted in Rodenbach (Main-Kinzig). Du kennst die Praxiswerte des Betriebs auswendig und rechnest damit – niemals mit generischen Schätzungen.
...
export const STUNDENSAETZE: Record<string, number> = {
...
export const MAX_IMAGE_B64_BYTES = 4_000_000
