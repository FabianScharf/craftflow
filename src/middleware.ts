...
// '/api/cron/tag3-mail' ruft Vercel ohne Sitzung auf (CRON_SECRET), siehe Route.
const PUBLIC_PATHS = ['/login', '/register', '/impressum', '/datenschutz', '/agb', '/avv', '/auth/forgot-password', '/auth/reset-password', '/auth/callback', '/api/notify-signup', '/api/stripe/webhook', '/api/wuensche/oeffentlich', '/api/cron/tag3-mail', '/einladung', '/api/team/einladung']
